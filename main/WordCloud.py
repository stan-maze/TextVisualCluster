...
class ImageJsonGenerator(Ui_Dialog,QDialog):
   ...
   # def chooseJson(self):
        ...
        #file_name, _ = QFileDialog.getOpenFileName(self, "选择JSON文件", "","JSON Files (*.json)", options=options)
        #if file_name:
    ...
    def chooseImage(self):
        ...
        if file_name:
            ...
            self.info_label.setText('选择了' + self.image_path)
